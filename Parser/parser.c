...
#define inverse_disjunction_type 1080
#define conjunction_type 1081
#define inverse_conjunction_type 1082
#define exclusive_disjunction_type 1083
#define inverse_exclusive_disjunction_type 1084
...
#define _loop1_93_type 1256
#define _loop1_94_type 1257
#define _loop1_95_type 1258
#define _loop1_96_type 1259
#define _tmp_97_type 1260
#define _loop0_99_type 1261
#define _gather_98_type 1262
#define _tmp_100_type 1263
#define _tmp_101_type 1264
#define _tmp_102_type 1265
#define _tmp_103_type 1266
#define _loop1_104_type 1267
#define _tmp_105_type 1268
#define _tmp_106_type 1269
#define _loop0_108_type 1270
#define _gather_107_type 1271
#define _loop1_109_type 1272
#define _loop0_110_type 1273
#define _loop0_111_type 1274
#define _tmp_112_type 1275
#define _tmp_113_type 1276
#define _loop0_115_type 1277
#define _gather_114_type 1278
#define _loop0_117_type 1279
#define _gather_116_type 1280
#define _loop0_119_type 1281
#define _gather_118_type 1282
#define _loop0_121_type 1283
#define _gather_120_type 1284
#define _loop0_122_type 1285
#define _loop0_124_type 1286
#define _gather_123_type 1287
#define _tmp_125_type 1288
#define _loop0_127_type 1289
#define _gather_126_type 1290
#define _loop0_129_type 1291
#define _gather_128_type 1292
#define _tmp_130_type 1293
#define _loop0_131_type 1294
...
#define _loop0_137_type 1300
#define _tmp_138_type 1301
#define _loop0_139_type 1302
...
#define _tmp_154_type 1317
#define _tmp_155_type 1318
#define _tmp_156_type 1319
#define _tmp_157_type 1320
#define _tmp_158_type 1321
#define _tmp_159_type 1322
#define _loop1_160_type 1323
#define _loop1_161_type 1324
#define _tmp_162_type 1325
#define _tmp_163_type 1326
...
static expr_ty inverse_disjunction_rule(Parser *p);
static expr_ty conjunction_rule(Parser *p);
static expr_ty inverse_conjunction_rule(Parser *p);
static expr_ty exclusive_disjunction_rule(Parser *p);
static expr_ty inverse_exclusive_disjunction_rule(Parser *p);
...
// disjunction: inverse_disjunction (('or' inverse_disjunction))+ | inverse_disjunction
static expr_ty
disjunction_rule(Parser *p)
{
    ...
    int _start_col_offset = p->tokens[_mark]->col_offset;
    UNUSED(_start_col_offset); // Only used by EXTRA macro
    { // inverse_disjunction (('or' inverse_disjunction))+
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> disjunction[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "inverse_disjunction (('or' inverse_disjunction))+"));
        expr_ty a;
        asdl_seq * b;
        if (
            (a = inverse_disjunction_rule(p))  // inverse_disjunction
            &&
            (b = _loop1_90_rule(p))  // (('or' inverse_disjunction))+
        )
        {
        ...
        D(fprintf(stderr, "%*c%s disjunction[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "inverse_disjunction (('or' inverse_disjunction))+"));
    }
    { // inverse_disjunction
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> disjunction[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "inverse_disjunction"));
        expr_ty inverse_disjunction_var;
        if (
            (inverse_disjunction_var = inverse_disjunction_rule(p))  // inverse_disjunction
        )
        {
            D(fprintf(stderr, "%*c+ disjunction[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "inverse_disjunction"));
            _res = inverse_disjunction_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s disjunction[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "inverse_disjunction"));
    }
    _res = NULL;
  done:
...
// inverse_disjunction: conjunction (('nor' conjunction))+ | conjunction
static expr_ty
inverse_disjunction_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    expr_ty _res = NULL;
    if (_PyPegen_is_memoized(p, inverse_disjunction_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    int _start_col_offset = p->tokens[_mark]->col_offset;
    UNUSED(_start_col_offset); // Only used by EXTRA macro
    { // conjunction (('nor' conjunction))+
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> inverse_disjunction[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "conjunction (('nor' conjunction))+"));
        expr_ty a;
        asdl_seq * b;
        if (
            (a = conjunction_rule(p))  // conjunction
            &&
            (b = _loop1_91_rule(p))  // (('nor' conjunction))+
        )
        {
            D(fprintf(stderr, "%*c+ inverse_disjunction[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "conjunction (('nor' conjunction))+"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_BoolOp ( Nor , CHECK ( _PyPegen_seq_insert_in_front ( p , a , b ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s inverse_disjunction[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "conjunction (('nor' conjunction))+"));
    }
    { // conjunction
        if (p->error_indicator) {
            D(p->level--);
    ...
    _PyPegen_insert_memo(p, _mark, inverse_disjunction_type, _res);
    D(p->level--);
    return _res;
}

// conjunction: inverse_conjunction (('and' inverse_conjunction))+ | inverse_conjunction
static expr_ty
conjunction_rule(Parser *p)
{
    ...
    int _start_col_offset = p->tokens[_mark]->col_offset;
    UNUSED(_start_col_offset); // Only used by EXTRA macro
    { // inverse_conjunction (('and' inverse_conjunction))+
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> conjunction[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "inverse_conjunction (('and' inverse_conjunction))+"));
        expr_ty a;
        asdl_seq * b;
        if (
            (a = inverse_conjunction_rule(p))  // inverse_conjunction
            &&
            (b = _loop1_92_rule(p))  // (('and' inverse_conjunction))+
        )
        {
        ...
        D(fprintf(stderr, "%*c%s conjunction[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "inverse_conjunction (('and' inverse_conjunction))+"));
    }
    { // inverse_conjunction
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> conjunction[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "inverse_conjunction"));
        expr_ty inverse_conjunction_var;
        if (
            (inverse_conjunction_var = inverse_conjunction_rule(p))  // inverse_conjunction
        )
        {
            D(fprintf(stderr, "%*c+ conjunction[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "inverse_conjunction"));
            _res = inverse_conjunction_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s conjunction[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "inverse_conjunction"));
    }
    _res = NULL;
  done:
...
// inverse_conjunction:
//     | exclusive_disjunction (('nand' exclusive_disjunction))+
//     | exclusive_disjunction
static expr_ty
inverse_conjunction_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    expr_ty _res = NULL;
    if (_PyPegen_is_memoized(p, inverse_conjunction_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // exclusive_disjunction (('nand' exclusive_disjunction))+
        ...
        D(fprintf(stderr, "%*c> inverse_conjunction[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "exclusive_disjunction (('nand' exclusive_disjunction))+"));
        expr_ty a;
        asdl_seq * b;
        if (
            (a = exclusive_disjunction_rule(p))  // exclusive_disjunction
            &&
            (b = _loop1_93_rule(p))  // (('nand' exclusive_disjunction))+
        )
        {
            D(fprintf(stderr, "%*c+ inverse_conjunction[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "exclusive_disjunction (('nand' exclusive_disjunction))+"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_BoolOp ( Nand , CHECK ( _PyPegen_seq_insert_in_front ( p , a , b ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s inverse_conjunction[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "exclusive_disjunction (('nand' exclusive_disjunction))+"));
    }
    { // exclusive_disjunction
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> inverse_conjunction[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "exclusive_disjunction"));
        expr_ty exclusive_disjunction_var;
        if (
            (exclusive_disjunction_var = exclusive_disjunction_rule(p))  // exclusive_disjunction
        )
        {
            D(fprintf(stderr, "%*c+ inverse_conjunction[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "exclusive_disjunction"));
            _res = exclusive_disjunction_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s inverse_conjunction[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "exclusive_disjunction"));
    }
    _res = NULL;
  done:
    _PyPegen_insert_memo(p, _mark, inverse_conjunction_type, _res);
    D(p->level--);
    return _res;
}

// exclusive_disjunction:
//     | inverse_exclusive_disjunction (('xor' inverse_exclusive_disjunction))+
//     | inverse_exclusive_disjunction
static expr_ty
exclusive_disjunction_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    expr_ty _res = NULL;
    if (_PyPegen_is_memoized(p, exclusive_disjunction_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    { // inverse_exclusive_disjunction (('xor' inverse_exclusive_disjunction))+
        ...
        D(fprintf(stderr, "%*c> exclusive_disjunction[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "inverse_exclusive_disjunction (('xor' inverse_exclusive_disjunction))+"));
        expr_ty a;
        asdl_seq * b;
        if (
            (a = inverse_exclusive_disjunction_rule(p))  // inverse_exclusive_disjunction
            &&
            (b = _loop1_94_rule(p))  // (('xor' inverse_exclusive_disjunction))+
        )
        {
            D(fprintf(stderr, "%*c+ exclusive_disjunction[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "inverse_exclusive_disjunction (('xor' inverse_exclusive_disjunction))+"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_BoolOp ( Xor , CHECK ( _PyPegen_seq_insert_in_front ( p , a , b ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s exclusive_disjunction[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "inverse_exclusive_disjunction (('xor' inverse_exclusive_disjunction))+"));
    }
    { // inverse_exclusive_disjunction
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> exclusive_disjunction[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "inverse_exclusive_disjunction"));
        expr_ty inverse_exclusive_disjunction_var;
        if (
            (inverse_exclusive_disjunction_var = inverse_exclusive_disjunction_rule(p))  // inverse_exclusive_disjunction
        )
        {
            D(fprintf(stderr, "%*c+ exclusive_disjunction[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "inverse_exclusive_disjunction"));
            _res = inverse_exclusive_disjunction_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s exclusive_disjunction[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "inverse_exclusive_disjunction"));
    }
    _res = NULL;
  done:
    _PyPegen_insert_memo(p, _mark, exclusive_disjunction_type, _res);
    D(p->level--);
    return _res;
}

// inverse_exclusive_disjunction: inversion (('xnor' inversion))+ | inversion
static expr_ty
inverse_exclusive_disjunction_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    expr_ty _res = NULL;
    if (_PyPegen_is_memoized(p, inverse_exclusive_disjunction_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    ...
    int _start_col_offset = p->tokens[_mark]->col_offset;
    UNUSED(_start_col_offset); // Only used by EXTRA macro
    { // inversion (('xnor' inversion))+
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> inverse_exclusive_disjunction[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "inversion (('xnor' inversion))+"));
        expr_ty a;
        asdl_seq * b;
        if (
            (a = inversion_rule(p))  // inversion
            &&
            (b = _loop1_95_rule(p))  // (('xnor' inversion))+
        )
        {
            D(fprintf(stderr, "%*c+ inverse_exclusive_disjunction[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "inversion (('xnor' inversion))+"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_BoolOp ( Xnor , CHECK ( _PyPegen_seq_insert_in_front ( p , a , b ) ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s inverse_exclusive_disjunction[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "inversion (('xnor' inversion))+"));
    }
    { // inversion
        if (p->error_indicator) {
            D(p->level--);
    ...
    _PyPegen_insert_memo(p, _mark, inverse_exclusive_disjunction_type, _res);
    D(p->level--);
    return _res;
}
...
// _loop1_90: ('or' inverse_disjunction)
static asdl_seq *
_loop1_90_rule(Parser *p)
{
    ...
    ssize_t _children_capacity = 1;
    ssize_t _n = 0;
    { // ('or' inverse_disjunction)
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _loop1_90[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "('or' inverse_disjunction)"));
        void *_tmp_149_var;
        while (
            (_tmp_149_var = _tmp_149_rule(p))  // 'or' inverse_disjunction
        )
        {
            _res = _tmp_149_var;
            if (_n == _children_capacity) {
        ...
        D(fprintf(stderr, "%*c%s _loop1_90[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "('or' inverse_disjunction)"));
    }
    if (_n == 0 || p->error_indicator) {
        PyMem_Free(_children);
        D(p->level--);
...
_loop1_91_rule(Parser *p)
{
    ...
    { // ('nor' conjunction)
        ...
        D(fprintf(stderr, "%*c> _loop1_91[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "('nor' conjunction)"));
        void *_tmp_150_var;
        while (
            (_tmp_150_var = _tmp_150_rule(p))  // 'nor' conjunction
        )
        {
            _res = _tmp_150_var;
            if (_n == _children_capacity) {
        ...
        D(fprintf(stderr, "%*c%s _loop1_91[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "('nor' conjunction)"));
    }
    if (_n == 0 || p->error_indicator) {
        PyMem_Free(_children);
        D(p->level--);
...
// _loop1_92: ('and' inverse_conjunction)
static asdl_seq *
_loop1_92_rule(Parser *p)
{
    ...
    ssize_t _children_capacity = 1;
    ssize_t _n = 0;
    { // ('and' inverse_conjunction)
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _loop1_92[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "('and' inverse_conjunction)"));
        void *_tmp_151_var;
        while (
            (_tmp_151_var = _tmp_151_rule(p))  // 'and' inverse_conjunction
        )
        {
            _res = _tmp_151_var;
            if (_n == _children_capacity) {
        ...
        D(fprintf(stderr, "%*c%s _loop1_92[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "('and' inverse_conjunction)"));
    }
    if (_n == 0 || p->error_indicator) {
        PyMem_Free(_children);
        D(p->level--);
...
// _loop1_93: ('nand' exclusive_disjunction)
static asdl_seq *
_loop1_93_rule(Parser *p)
{
    ...
    ssize_t _children_capacity = 1;
    ssize_t _n = 0;
    { // ('nand' exclusive_disjunction)
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _loop1_93[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "('nand' exclusive_disjunction)"));
        void *_tmp_152_var;
        while (
            (_tmp_152_var = _tmp_152_rule(p))  // 'nand' exclusive_disjunction
        )
        {
            _res = _tmp_152_var;
            if (_n == _children_capacity) {
        ...
        D(fprintf(stderr, "%*c%s _loop1_93[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "('nand' exclusive_disjunction)"));
    }
    if (_n == 0 || p->error_indicator) {
        PyMem_Free(_children);
        D(p->level--);
...
// _loop1_94: ('xor' inverse_exclusive_disjunction)
static asdl_seq *
_loop1_94_rule(Parser *p)
{
    ...
    ssize_t _children_capacity = 1;
    ssize_t _n = 0;
    { // ('xor' inverse_exclusive_disjunction)
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _loop1_94[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "('xor' inverse_exclusive_disjunction)"));
        void *_tmp_153_var;
        while (
            (_tmp_153_var = _tmp_153_rule(p))  // 'xor' inverse_exclusive_disjunction
        )
        {
            _res = _tmp_153_var;
            if (_n == _children_capacity) {
        ...
        D(fprintf(stderr, "%*c%s _loop1_94[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "('xor' inverse_exclusive_disjunction)"));
    }
    if (_n == 0 || p->error_indicator) {
        PyMem_Free(_children);
        D(p->level--);
...
_loop1_95_rule(Parser *p)
{
    ...
    { // ('xnor' inversion)
        ...
        D(fprintf(stderr, "%*c> _loop1_95[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "('xnor' inversion)"));
        void *_tmp_154_var;
        while (
            (_tmp_154_var = _tmp_154_rule(p))  // 'xnor' inversion
        )
        {
            _res = _tmp_154_var;
            if (_n == _children_capacity) {
        ...
        D(fprintf(stderr, "%*c%s _loop1_95[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "('xnor' inversion)"));
    }
    if (_n == 0 || p->error_indicator) {
        PyMem_Free(_children);
        D(p->level--);
...
_tmp_138_rule(Parser *p)
{
    ...
    { // param_with_default+
        ...
        if (
            (_loop1_160_var = _loop1_160_rule(p))  // param_with_default+
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_138[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "param_with_default+"));
            _res = _loop1_160_var;
...
_tmp_140_rule(Parser *p)
{
    ...
    { // lambda_param_with_default+
        ...
        if (
            (_loop1_161_var = _loop1_161_rule(p))  // lambda_param_with_default+
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_140[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "lambda_param_with_default+"));
            _res = _loop1_161_var;
...
// _tmp_149: 'or' inverse_disjunction
static void *
_tmp_149_rule(Parser *p)
{
    ...
    { // 'or' inverse_disjunction
        ...
        if (
            ...
            &&
            (c = inverse_disjunction_rule(p))  // inverse_disjunction
        )
        {
...
_tmp_150_rule(Parser *p)
{
    ...
    { // 'nor' conjunction
        ...
        expr_ty c;
        if (
            (_keyword = _PyPegen_expect_token(p, 532))  // token='nor'
            &&
...
// _tmp_151: 'and' inverse_conjunction
static void *
_tmp_151_rule(Parser *p)
{
    ...
    { // 'and' inverse_conjunction
        ...
        if (
            ...
            &&
            (c = inverse_conjunction_rule(p))  // inverse_conjunction
        )
        {
...
// _tmp_152: 'nand' exclusive_disjunction
static void *
_tmp_152_rule(Parser *p)
{
    ...
    { // 'nand' exclusive_disjunction
        ...
        expr_ty c;
        if (
            (_keyword = _PyPegen_expect_token(p, 534))  // token='nand'
            &&
            (c = exclusive_disjunction_rule(p))  // exclusive_disjunction
        )
        {
...
// _tmp_153: 'xor' inverse_exclusive_disjunction
static void *
_tmp_153_rule(Parser *p)
{
    ...
    { // 'xor' inverse_exclusive_disjunction
        ...
        expr_ty c;
        if (
            (_keyword = _PyPegen_expect_token(p, 535))  // token='xor'
            &&
            (c = inverse_exclusive_disjunction_rule(p))  // inverse_exclusive_disjunction
        )
        {
...
_tmp_154_rule(Parser *p)
{
    ...
    { // 'xnor' inversion
        ...
        expr_ty c;
        if (
            (_keyword = _PyPegen_expect_token(p, 536))  // token='xnor'
            &&
...
// _loop1_161: lambda_param_with_default
static asdl_seq *
