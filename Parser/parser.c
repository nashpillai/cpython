...
_loop1_90_rule(Parser *p)
{
    ...
    { // ('or' inverse_disjunction)
        ...
        void *_tmp_146_var;
        while (
            (_tmp_146_var = _tmp_146_rule(p))  // 'or' inverse_disjunction
        )
        {
            _res = _tmp_146_var;
            if (_n == _children_capacity) {
...
_loop1_91_rule(Parser *p)
{
    ...
    { // ('nor' conjunction)
        ...
        void *_tmp_147_var;
        while (
            (_tmp_147_var = _tmp_147_rule(p))  // 'nor' conjunction
        )
        {
            _res = _tmp_147_var;
            if (_n == _children_capacity) {
...
// _tmp_146: 'or' inverse_disjunction
static void *
